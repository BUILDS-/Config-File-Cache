...
main = do 
  ...
  xmonad $ defaultConfig {
        ...
        keys               = \conf@(XConfig {XMonad.modMask = modm}) -> M.fromList $
                                                                        ...
                                                                        , ((modm .|. shiftMask, xK_x     ), spawn "xfce4-terminal -x bash -c \"gksudo sleep 0; gnome-screensaver-command --lock; sudo pm-suspend\"") -- I need to have root for the pm-suspend command, and I can't call the screensaver lock command as root.
